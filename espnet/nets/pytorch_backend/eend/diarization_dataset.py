...
import numpy as np
import chainer
from espnet.nets.pytorch_backend.eend import kaldi_data
from espnet.nets.pytorch_backend.eend import feature
...
#            print(rec)
#            print(self.data.reco2dur[rec],rate,frame_shift,chunk_size,data_len,self.subsampling)
#            print(_count_frames(data_len, chunk_size, chunk_size))
#            for st, ed in  _gen_frame_indices(data_len, chunk_size, chunk_size, use_last_samples,
