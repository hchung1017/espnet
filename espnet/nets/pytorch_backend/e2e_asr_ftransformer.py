...
from espnet.nets.pytorch_backend.ftransformer.decoder import Decoder
from espnet.nets.pytorch_backend.ftransformer.encoder import Encoder
from espnet.nets.pytorch_backend.ftransformer.initializer import initialize
from espnet.nets.pytorch_backend.ftransformer.label_smoothing_loss import LabelSmoothingLoss
from espnet.nets.pytorch_backend.ftransformer.plot import PlotAttentionReport
...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def add_arguments(parser):
        ...
        group.add_argument('--low_rank', help='Use factorized matrix', action='store_true')
        group.add_argument('--low_rank_thr', default=0.05, type=float,
                           help='Low rank threshold')
        return parser
